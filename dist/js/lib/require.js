...
!(function (global, setTimeout) {
  ...
  function mixin (e, t, i, r) {
    return t && eachProp(t, function (t, n) {
      !i && hasProp(e, n) || (!r || typeof t !== 'object' || !t || isArray(t) || isFunction(t) || t instanceof RegExp ? e[n] = t : (e[n] || (e[n] = {}), mixin(e[n], t, i, r)))
    }), e
  }
  ...
  function newContext (e) {
    ...
    function a (e, t, r, n) {
      ...
      return e || (l = !1, e = '_@r' + (T += 1)), c = o(e), d = c[0], e = c[1], d && (d = i(d, p, n), s = getOwn(j, d)), e && (d ? h = r ? e : s && s.normalize ? s.normalize(e, function (e) {
        return i(e, p, n)
      }) : e.indexOf('!') === -1 ? i(e, p, n) : e : (d = (c = o(h = i(e, p, n)))[0], h = c[1], r = !0, a = q.nameToUrl(h))), u = !d || s || r ? '' : '_unnormalized' + (A += 1), {
        prefix: d,
        name: h,
        parentMap: t,
        unnormalized: !!u,
    ...
    function u (e, t, i) {
      var r = e.id,
        n = getOwn(S, r)
      !hasProp(j, r) || n && !n.defineEmitComplete ? (n = s(e)).error && t === 'error' ? i(n.error) : n.on(t, i) : t === 'defined' && i(j[r])
    }
    ...
    function v () {
      var e
      for (d(); O.length;) {
        if ((e = O.shift())[0] === null) return c(makeError('mismatch', 'Mismatched anonymous define() module: ' + e[e.length - 1]))
        h(e)
      }
      q.defQueueMap = {}
    }
        ...
        this.depMaps.push(r), u(r, 'defined', bind(this, function (r) {
          ...
          return this.map.unnormalized ? (r.normalize && (l = r.normalize(l, function (e) {
            ...
            this.inited = !0, this.error = e, e.requireModules = [t], eachProp(S, function (e) {
              e.map.id.indexOf(t + '_unnormalized') === 0 && p(e.map.id)
            }), c(e)
  ...
  if (void 0 === define) {
    ...
    void 0 === require || isFunction(require) || (cfg = require, require = void 0), req = requirejs = function (e, t, i, r) {
      ...
      var r, n
      typeof e !== 'string' && (i = t, t = e, e = null), isArray(t) || (i = t, t = null), !t && isFunction(i) && (t = [], i.length && (i.toString().replace(commentRegExp, commentReplace).replace(cjsRequireRegExp, function (e, i) {
        t.push(i)
      }), t = (i.length === 1 ? ['require'] : ['require', 'exports', 'module']).concat(t))), useInteractive && (r = currentlyAddingScript || getInteractiveScript()) && (e || (e = r.getAttribute('data-requiremodule')), n = contexts[r.getAttribute('data-requirecontext')]), n ? (n.defQueue.push([e, t, i]), n.defQueueMap[e] = !0) : globalDefQueue.push([e, t, i])
    }, define.amd = {
      jQuery: !0
